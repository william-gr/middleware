...
## Acceptable values:
##   - the path to a file
## ssl.certfile = /usr/local/etc/riak-cs/cert.pem
...
## Acceptable values:
##   - the path to a file
## ssl.keyfile = /usr/local/etc/riak-cs/key.pem
...
## Acceptable values:
##   - an IP/port pair, e.g. 192.168.1.37:10011
## admin.listener = 192.168.1.37:8000
...
## cs_root_host = builder.optimcloud.com
